...
int main()
{
    ...
    for (ll Z = 0; Z < t; Z++)
    {
        ...
        cin >> s;
        ll a = 1;
        if ((s[1] == 'A' || s[1] == 'E' || s[1] == 'I' || s[1] == 'O' || s[1] == 'U') && (s[3] == 'A' || s[3] == 'E' || s[3] == 'I' || s[3] == 'O' || s[3] == 'U') && (s[5] == 'A' || s[5] == 'E' || s[5] == 'I' || s[5] == 'O' || s[5] == 'U'))
            ;
        else
            a = 0;
        vector<int> v = {0, 2, 4, 6, 7};
        for (auto it : v)
        {
            if ((s[it] != 'A' && s[it] != 'E' && s[it] != 'I' && s[it] != 'O' && s[it] != 'U'))
                ;
            else
                a = 0;
        }
